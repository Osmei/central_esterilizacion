...
const Instrumentales = Loadable({
  loader: () => import('./views/Configuracion/Instrumental/Instrumentales'),
  loading: Loading,
});

const Instrumental = Loadable({
  loader: () => import('./views/Configuracion/Instrumental/Instrumental'),
  loading: Loading,
});

const Productos = Loadable({
  loader: () => import('./views/Configuracion/Productos/Productos'),
  loading: Loading,
});

const Producto = Loadable({
  loader: () => import('./views/Configuracion/Productos/Producto'),
  loading: Loading,
});
...
const routes = [
  ...
  { path: '/configuracion/productos/editar/:id', exact: true, name: 'Modificación de Producto', component: Producto },
